/* 
### CUSTOMIZATION ###
### CSS and JS files are compressed and uglified, it may be dificult to modify. 
### Check full version for full editable here
### Download All Variant Theme: https://l.linklyhq.com/l/1FVQn
*/
 ...
 *  @license MIT
 */
!function(e,a){"function"==typeof define&&define.amd?define(["jquery"],(function(e){return a(e)})):"object"==typeof module&&module.exports?module.exports=a(require("jquery")):a(e.jQuery)}(this,(function(e){!function(e,a){"use strict";e.formUtils.registerLoadedModule("security"),e.formUtils.addValidator({name:"spamcheck",validatorFunction:function(e,a){return a.valAttr("captcha")===e},errorMessage:"",errorMessageKey:"badSecurityAnswer"}),e.formUtils.addValidator({name:"confirmation",validatorFunction:function(a,t,r,n,i){var o,d=t.valAttr("confirm")||t.attr("name")+"_confirmation",l=i.find('[name="'+d+'"]');if(!l.length)return e.formUtils.warn('Password confirmation validator: could not find an input with name "'+d+'"',!0),!1;if(o=l.val(),r.validateOnBlur&&!l[0].hasValidationCallback){l[0].hasValidationCallback=!0;var s=function(){t.validate()};l.on("keyup",s),i.one("formValidationSetup",(function(){l[0].hasValidationCallback=!1,l.off("keyup",s)}))}return a===o},errorMessage:"",errorMessageKey:"notConfirmed"});var t={amex:[15,15],diners_club:[14,14],cjb:[16,16],laser:[16,19],visa:[16,16],mastercard:[16,16],maestro:[12,19],discover:[16,16]},r=!1,n=!1;e.formUtils.addValidator({name:"creditcard",validatorFunction:function(a,i){var o=e.split(i.valAttr("allowing")||"");if(n=e.inArray("amex",o)>-1,r=n&&1===o.length,o.length>0){var d=!1;if(e.each(o,(function(r,n){if(n in t){if(a.length>=t[n][0]&&a.length<=t[n][1])return d=!0,!1}else e.formUtils.warn('Use of unknown credit card "'+n+'"',!0)})),!d)return!1}if(""!==a.replace(new RegExp("[0-9]","g"),""))return!1;var l=0;return e.each(a.split("").reverse(),(function(e,a){a=parseInt(a,10),e%2==0?l+=a:l+=(a*=2)<10?a:a-9})),l%10==0},errorMessage:"",errorMessageKey:"badCreditCard"}),e.formUtils.addValidator({name:"cvv",validatorFunction:function(e){return""===e.replace(/[0-9]/g,"")&&(e+="",r?4===e.length:n?3===e.length||4===e.length:3===e.length)},errorMessage:"",errorMessageKey:"badCVV"}),e.formUtils.addValidator({name:"strength",validatorFunction:function(a,t){var r=t.valAttr("strength")||2;return r&&r>3&&(r=3),e.formUtils.validators.validate_strength.calculatePasswordStrength(a)>=r},errorMessage:"",errorMessageKey:"badStrength",calculatePasswordStrength:function(e){if(e.length<4)return 0;var a=0,t=function(e,a){for(var t="",r=0;r<a.length;r++){for(var n=!0,i=0;i<e&&i+r+e<a.length;i++)n=n&&a.charAt(i+r)===a.charAt(i+r+e);i<e&&(n=!1),n?(r+=e-1,n=!1):t+=a.charAt(r)}return t};return a+=4*e.length,a+=1*(t(1,e).length-e.length),a+=1*(t(2,e).length-e.length),a+=1*(t(3,e).length-e.length),a+=1*(t(4,e).length-e.length),e.match(/(.*[0-9].*[0-9].*[0-9])/)&&(a+=5),e.match(/(.*[!,@,#,$,%,^,&,*,?,_,~].*[!,@,#,$,%,^,&,*,?,_,~])/)&&(a+=5),e.match(/([a-z].*[A-Z])|([A-Z].*[a-z])/)&&(a+=10),e.match(/([a-zA-Z])/)&&e.match(/([0-9])/)&&(a+=15),e.match(/([!,@,#,$,%,^,&,*,?,_,~])/)&&e.match(/([0-9])/)&&(a+=15),e.match(/([!,@,#,$,%,^,&,*,?,_,~])/)&&e.match(/([a-zA-Z])/)&&(a+=15),(e.match(/^\w+$/)||e.match(/^\d+$/))&&(a-=10),a<0&&(a=0),a>100&&(a=100),a<20?0:a<40?1:a<=60?2:3},strengthDisplay:function(a,t){var r={fontSize:"12pt",padding:"4px",bad:"Very bad",weak:"Weak",good:"Good",strong:"Strong"};t&&e.extend(r,t),a.bind("keyup",(function(){var a=e(this).val(),t=void 0===r.parent?e(this).parent():e(r.parent),n=t.find(".strength-meter"),i=e.formUtils.validators.validate_strength.calculatePasswordStrength(a),o={background:"pink",color:"#FF0000",fontWeight:"bold",border:"red solid 1px",borderWidth:"0px 0px 4px",display:"inline-block",fontSize:r.fontSize,padding:r.padding},d=r.bad;0===n.length&&(n=e("<span></span>")).addClass("strength-meter").appendTo(t),a?n.show():n.hide(),1===i?d=r.weak:2===i?(o.background="lightyellow",o.borderColor="yellow",o.color="goldenrod",d=r.good):i>=3&&(o.background="lightgreen",o.borderColor="darkgreen",o.color="darkgreen",d=r.strong),n.css(o).text(d)}))}});var i=function(a,t,r,n,i){var o=t.valAttr("req-params")||t.data("validation-req-params")||{},d=t.valAttr("param-name")||t.attr("name"),l=function(e,a){a(e)};if(!d)throw new Error("Missing input name used for http requests made by server validator");o||(o={}),"string"==typeof o&&(o=e.parseJSON(o)),o[d]=r,e.ajax({url:a,type:"POST",cache:!1,data:o,dataType:"json",error:function(e){return l({valid:!1,message:"Connection failed with status: "+e.statusText},i),!1},success:function(e){l(e,i)}})};e.formUtils.addAsyncValidator({name:"server",validatorFunction:function(e,a,t,r,n,o){var d=t.valAttr("url")||r.backendUrl||document.location.href;o.addClass("validating-server-side"),t.addClass("validating-server-side"),i(d,t,a,0,(function(a){o.removeClass("validating-server-side"),t.removeClass("validating-server-side"),a.message&&t.attr(r.validationErrorMsgAttribute,a.message),e(a.valid)}))},errorMessage:"",errorMessageKey:"badBackend"}),e.formUtils.addValidator({name:"letternumeric",validatorFunction:function(a,t,r,n){var i="^([a-zA-Z0-9ªµºÀ-ÖØ-öø-ˁˆ-ˑˠ-ˤˬˮͰ-ʹͶͷͺ-ͽΆΈ-ΊΌΎ-ΡΣ-ϵϷ-ҁҊ-ԧԱ-Ֆՙա-ևא-תװ-ײؠ-يٮٯٱ-ۓەۥۦۮۯۺ-ۼۿܐܒ-ܯݍ-ޥޱߊ-ߪߴߵߺࠀ-ࠕࠚࠤࠨࡀ-ࡘࢠࢢ-ࢬऄ-हऽॐक़-ॡॱ-ॷॹ-ॿঅ-ঌএঐও-নপ-রলশ-হঽৎড়ঢ়য়-ৡৰৱਅ-ਊਏਐਓ-ਨਪ-ਰਲਲ਼ਵਸ਼ਸਹਖ਼-ੜਫ਼ੲ-ੴઅ-ઍએ-ઑઓ-નપ-રલળવ-હઽૐૠૡଅ-ଌଏଐଓ-ନପ-ରଲଳଵ-ହଽଡ଼ଢ଼ୟ-ୡୱஃஅ-ஊஎ-ஐஒ-கஙசஜஞடணதந-பம-ஹௐఅ-ఌఎ-ఐఒ-నప-ళవ-హఽౘౙౠౡಅ-ಌಎ-ಐಒ-ನಪ-ಳವ-ಹಽೞೠೡೱೲഅ-ഌഎ-ഐഒ-ഺഽൎൠൡൺ-ൿඅ-ඖක-නඳ-රලව-ෆก-ะาำเ-ๆກຂຄງຈຊຍດ-ທນ-ຟມ-ຣລວສຫອ-ະາຳຽເ-ໄໆໜ-ໟༀཀ-ཇཉ-ཬྈ-ྌက-ဪဿၐ-ၕၚ-ၝၡၥၦၮ-ၰၵ-ႁႎႠ-ჅჇჍა-ჺჼ-ቈቊ-ቍቐ-ቖቘቚ-ቝበ-ኈኊ-ኍነ-ኰኲ-ኵኸ-ኾዀዂ-ዅወ-ዖዘ-ጐጒ-ጕጘ-ፚᎀ-ᎏᎠ-Ᏼᐁ-ᙬᙯ-ᙿᚁ-ᚚᚠ-ᛪᜀ-ᜌᜎ-ᜑᜠ-ᜱᝀ-ᝑᝠ-ᝬᝮ-ᝰក-ឳៗៜᠠ-ᡷᢀ-ᢨᢪᢰ-ᣵᤀ-ᤜᥐ-ᥭᥰ-ᥴᦀ-ᦫᧁ-ᧇᨀ-ᨖᨠ-ᩔᪧᬅ-ᬳᭅ-ᭋᮃ-ᮠᮮᮯᮺ-ᯥᰀ-ᰣᱍ-ᱏᱚ-ᱽᳩ-ᳬᳮ-ᳱᳵᳶᴀ-ᶿḀ-ἕἘ-Ἕἠ-ὅὈ-Ὅὐ-ὗὙὛὝὟ-ώᾀ-ᾴᾶ-ᾼιῂ-ῄῆ-ῌῐ-ΐῖ-Ίῠ-Ῥῲ-ῴῶ-ῼⁱⁿₐ-ₜℂℇℊ-ℓℕℙ-ℝℤΩℨK-ℭℯ-ℹℼ-ℿⅅ-ⅉⅎↃↄⰀ-Ⱞⰰ-ⱞⱠ-ⳤⳫ-ⳮⳲⳳⴀ-ⴥⴧⴭⴰ-ⵧⵯⶀ-ⶖⶠ-ⶦⶨ-ⶮⶰ-ⶶⶸ-ⶾⷀ-ⷆⷈ-ⷎⷐ-ⷖⷘ-ⷞⸯ々〆〱-〵〻〼ぁ-ゖゝ-ゟァ-ヺー-ヿㄅ-ㄭㄱ-ㆎㆠ-ㆺㇰ-ㇿ㐀-䶵一-鿌ꀀ-ꒌꓐ-ꓽꔀ-ꘌꘐ-ꘟꘪꘫꙀ-ꙮꙿ-ꚗꚠ-ꛥꜗ-ꜟꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꠁꠃ-ꠅꠇ-ꠊꠌ-ꠢꡀ-ꡳꢂ-ꢳꣲ-ꣷꣻꤊ-ꤥꤰ-ꥆꥠ-ꥼꦄ-ꦲꧏꨀ-ꨨꩀ-ꩂꩄ-ꩋꩠ-ꩶꩺꪀ-ꪯꪱꪵꪶꪹ-ꪽꫀꫂꫛ-ꫝꫠ-ꫪꫲ-ꫴꬁ-ꬆꬉ-ꬎꬑ-ꬖꬠ-ꬦꬨ-ꬮꯀ-ꯢ가-힣ힰ-ퟆퟋ-ퟻ豈-舘並-龎ﬀ-ﬆﬓ-ﬗיִײַ-ﬨשׁ-זּטּ-לּמּנּסּףּפּצּ-ﮱﯓ-ﴽﵐ-ﶏﶒ-ﷇﷰ-ﷻﹰ-ﹴﹶ-ﻼＡ-Ｚａ-ｚｦ-ﾾￂ-ￇￊ-ￏￒ-ￗￚ-ￜ",o="]+)$",d=t.valAttr("allowing"),l="";if(d){l=i+d+o;var s=d.replace(/\\/g,"");s.indexOf(" ")>-1&&(s=s.replace(" ",""),s+=n.andSpaces||e.formUtils.LANG.andSpaces),this.errorMessage=n.badAlphaNumeric+n.badAlphaNumericExtra+s}else l=i+o,this.errorMessage=n.badAlphaNumeric;return new RegExp(l).test(a)},errorMessage:"",errorMessageKey:"requiredFields"}),e.formUtils.addValidator({name:"complexity",validatorFunction:function(a,t,r,n){var i=t.valAttr("require-uc-letter")||"0",o=t.valAttr("require-lc-letter")||"0",d=t.valAttr("require-special-char")||"0",l=t.valAttr("require-numeral")||"0",s=t.valAttr("require-length")||"0",c={"uc-letter":{pattern:"^(?=(?:.*[A-Z]){"+i+",}).+",numRequired:i,dialogEnd:n.passwordComplexityUppercaseInfo},"lc-letter":{pattern:"^(?=(?:.*[a-z]){"+o+",}).+",numRequired:o,dialogEnd:n.passwordComplexityLowercaseInfo},"special-char":{pattern:"^(?=(?:.*(_|[!\"#$%&'()*+\\\\,-./:;<=>?@[\\]^_`{|}~])){"+d+",}).+",numRequired:d,dialogEnd:n.passwordComplexitySpecialCharsInfo},numeral:{pattern:"^(?=(?:.*\\d){"+l+",}).+",numRequired:l,dialogEnd:n.passwordComplexityNumericCharsInfo},length:{callback:function(e){return e.length>=s},numRequired:s,dialogEnd:n.lengthBadEnd}},h="";return e.each(c,(function(e,r){var i=parseInt(r.numRequired,10);if(i){var o=new RegExp(r.pattern);(r.callback?r.callback(a):o.test(a))?t.trigger("complexityRequirementValidation",[!0,e]):(""===h&&(h=n.passwordComplexityStart),h+=n.passwordComplexitySeparator+i+r.dialogEnd,t.trigger("complexityRequirementValidation",[!1,e]))}})),!h||(this.errorMessage=h+n.passwordComplexityEnd,!1)},errorMessage:"",errorMessageKey:""}),e.formUtils.addValidator({name:"recaptcha",validatorFunction:function(e,a){return""!==grecaptcha.getResponse(a.valAttr("recaptcha-widget-id"))},errorMessage:"",errorMessageKey:"badreCaptcha"}),e.fn.displayPasswordStrength=function(a){return new e.formUtils.validators.validate_strength.strengthDisplay(this,a),this};a.reCaptchaLoaded=function(a){a&&"object"==typeof a&&a.length||(a=e("form")),a.each((function(){var a=e(this),t=a.get(0).validationConfig||a.context.validationConfig||!1;t&&e('[data-validation~="recaptcha"]',a).each((function(){var r=e(this),n=document.createElement("DIV"),i=t.reCaptchaSiteKey||r.valAttr("recaptcha-sitekey"),o=t.reCaptchaTheme||r.valAttr("recaptcha-theme")||"light",d=t.reCaptchaSize||r.valAttr("recaptcha-size")||"normal",l=t.reCaptchaType||r.valAttr("recaptcha-type")||"image";if(!i)throw new Error("Google reCaptcha site key is required.");var s=grecaptcha.render(n,{sitekey:i,theme:o,size:d,type:l,callback:function(e){a.find('[data-validation~="recaptcha"]').trigger("validation",e&&""!==e)},"expired-callback":function(){a.find('[data-validation~="recaptcha"]').trigger("validation",!1)}});r.valAttr("recaptcha-widget-id",s).hide().on("beforeValidation",(function(e){e.stopImmediatePropagation()})).parent().append(n)}))}))},e(a).on("validatorsLoaded formValidationSetup",(function(a,t,r){if(t||(t=e("form")),"undefined"!=typeof grecaptcha&&!e.formUtils.hasLoadedGrecaptcha)throw new Error("reCaptcha API can not be loaded by hand, delete reCaptcha API snippet.");if(!e.formUtils.hasLoadedGrecaptcha&&e('[data-validation~="recaptcha"]',t).length){e.formUtils.hasLoadedGrecaptcha=!0;var n="//www.google.com/recaptcha/api.js?onload=reCaptchaLoaded&render=explicit"+(r.lang?"&hl="+r.lang:""),i=document.createElement("script");i.type="text/javascript",i.async=!0,i.defer=!0,i.src=n,document.getElementsByTagName("body")[0].appendChild(i)}}))}(e,window)}));
...
var $photoCarousel=$("#about_photo_carousel"),$teamCarousel=$("#about_team_carousel"),$teamPrev=$("#team_prev"),$teamNext=$("#team_next");$(document).ready((function(){$photoCarousel.slick({dots:!1,arrows:!1,slidesToShow:3,infinite:!0,autoplay:!1,responsive:[{breakpoint:800,settings:{slidesToShow:2,slidesToScroll:1}},{breakpoint:600,settings:{slidesToShow:1,slidesToScroll:1}}]}),$teamCarousel.slick({dots:!0,arrows:!1,slidesToShow:1,variableWidth:!0,autoplay:!1,responsive:[{breakpoint:800,settings:{slidesToShow:2,slidesToScroll:1}},{breakpoint:600,settings:{slidesToShow:1,slidesToScroll:1}}]}),$teamPrev.click((function(){$photoCarousel.slick("slickPrev")})),$teamNext.click((function(){$photoCarousel.slick("slickNext")}))})),$photoCarousel.each((function(){$(this).magnificPopup({delegate:".item a",type:"image",mainClass:"mfp-with-zoom",gallery:{enabled:!0},zoom:{enabled:!0,duration:300,easing:"ease-in-out",opener:function(e){return e.is("img")?e:e.find("img")}}})}));var tag=document.createElement("script");tag.src="https://www.youtube.com/iframe_api";var firstScriptTag=document.getElementsByTagName("script")[0],player;function onYouTubeIframeAPIReady(){player=new YT.Player("video_iframe",{height:"360",width:"640",videoId:"sf15CtXuw9M",playerVars:{autoplay:0},events:{onReady:onPlayerReady,onStateChange:onPlayerStateChange}})}function onPlayerReady(e){}firstScriptTag.parentNode.insertBefore(tag,firstScriptTag);var done=!1;function onPlayerStateChange(e){e.data!=YT.PlayerState.PLAYING||done||(setTimeout(stopVideo,6e3),done=!0)}function playVideo(){player.playVideo()}function stopVideo(){player.stopVideo()}$((function(){$("#video_modal.modal").modal({onOpenEnd:function(){playVideo()},onCloseEnd:function(){stopVideo()}}),$("#video_modal.modal .modal-close").click((function(){stopVideo()}))})),$("#case_categories li").click((function(){$("#case_categories li").removeClass("active"),$(this).addClass("active")}));var $carousel=$("#banner_slider"),$carouselDeco=$("#slider_deco"),$carouselNav=$("#banner_nav a");$((function(){$carousel.slick({dots:!1,arrows:!1,speed:800,slidesToShow:1,infinite:!0,autoplay:!1,cssEase:"ease-out",asNavFor:".slider-deco",responsive:[{breakpoint:960,settings:{dots:!0,fade:!0}}]}),$carouselDeco.slick({dots:!1,arrows:!1,slidesToShow:1,infinite:!0,fade:!0,cssEase:"ease-out",autoplay:!1})})),$carouselNav.click((function(){var e=$(this).data("slide");$carousel.slick("slickGoTo",e)})),$carousel.on("afterChange",(function(e,t,a){var i=a;$carouselNav.removeClass("active"),$("#banner_nav > a[data-slide="+i+"]").addClass("active")}));var $chatPanel=$("#chat_panel"),$closeChat=$("#close_chat"),$chatContainer=$("#chat-container ul"),$chatField=$("#chat_field"),$sendMessage=$("#send_message"),$toggleChat=$("#toggle_chat");function sendChat(){var e=$chatField.val();$chatContainer.append('<li class="justify-content-end"><span class="talk">'+e+"</span></li>"),$chatField.val("");var t=document.getElementById("chat-container");setTimeout((function(){t.scrollTo(0,t.scrollHeight)}),300)}function removeArray(e){for(var t,a,i=arguments,o=i.length;o>1&&e.length;)for(t=i[--o];-1!==(a=e.indexOf(t));)e.splice(a,1);return e}$toggleChat.click((function(){$chatPanel.toggleClass("show")})),$closeChat.click((function(){$chatPanel.removeClass("show")})),$sendMessage.click((function(){sendChat()})),$chatField.on("keypress",(function(e){13==e.which&&sendChat()})),function($){function numberRoller(e){var t=$(".roller-title-number-"+e).attr("data-min"),a=$(".roller-title-number-"+e).attr("data-max"),i=$(".roller-title-number-"+e).attr("data-delay");numberRoll(e,t,a,$(".roller-title-number-"+e).attr("data-increment"),1e3*i/(a-t))}function numberRoll(slno,min,max,increment,timeout){min<=max?($(".roller-title-number-"+slno).html(min),min=parseInt(min)+parseInt(increment),setTimeout((function(){numberRoll(eval(slno),eval(min),eval(max),eval(increment),eval(timeout))}),timeout)):$(".roller-title-number-"+slno).html(max)}$(window).on("load",(function(){$(document).scrollzipInit(),$(document).rollerInit()})),$(window).on("load scroll resize",(function(){$(".numscroller").scrollzip({showFunction:function(){numberRoller($(this).attr("data-slno"))},wholeVisible:!1})})),$.fn.scrollzipInit=function(){$("body").prepend("<div style='position:fixed;top:0px;left:0px;width:0;height:0;' id='scrollzipPoint'></div>")},$.fn.rollerInit=function(){var e=0;$(".numscroller").each((function(){e++,$(this).attr("data-slno",e),$(this).addClass("roller-title-number-"+e)}))},$.fn.scrollzip=function(e){var t=$.extend({showFunction:null,hideFunction:null,showShift:0,wholeVisible:!1,hideShift:0},e);return this.each((function(e,a){return $(this).addClass("scrollzip"),$.isFunction(t.showFunction)&&$("#scrollzipPoint").length>0&&!$(this).hasClass("isShown")&&$(window).outerHeight()+$("#scrollzipPoint").offset().top-t.showShift>$(this).offset().top+(t.wholeVisible?$(this).outerHeight():0)&&$("#scrollzipPoint").offset().top+(t.wholeVisible?$(this).outerHeight():0)<$(this).outerHeight()+$(this).offset().top-t.showShift&&($(this).addClass("isShown"),t.showFunction.call(this)),$.isFunction(t.hideFunction)&&$(this).hasClass("isShown")&&($(window).outerHeight()+$("#scrollzipPoint").offset().top-t.hideShift<$(this).offset().top+(t.wholeVisible?$(this).outerHeight():0)||$("#scrollzipPoint").offset().top+(t.wholeVisible?$(this).outerHeight():0)>$(this).outerHeight()+$(this).offset().top-t.hideShift)&&($(this).removeClass("isShown"),t.hideFunction.call(this)),this}))}}(jQuery),$(document).ready((function(){var e=$("#facilities_carousel");if("rtl"===$("html").attr("dir")){var t=Math.floor(e.data("length")-2);setTimeout((function(){e.slick("slickGoTo",t)}),100)}e.slick({dots:!1,infinite:!1,speed:500,slidesToShow:4,arrows:!1,slidesToScroll:1,variableWidth:!0,responsive:[{breakpoint:800,settings:{slidesToShow:2}},{breakpoint:480,settings:{slidesToShow:1}}]});var a=$("#art_facilities");e.on("afterChange",(function(e,t){t.currentSlide>=1?a.addClass("faded"):a.removeClass("faded")})),$("#prev_facility").click((function(){e.slick("slickPrev")})),$("#next_facility").click((function(){e.slick("slickNext")}))})),$("#switch_view button").click((function(){$("#switch_view button").removeClass("active"),$(this).addClass("active"),"grid"===$(this).data("value")?($("#product_result > .col").addClass("col-lg-4").removeClass("col-sm-12"),$("#product_result .product-card").addClass("portrait").removeClass("landscape")):($("#product_result > .col").addClass("col-sm-12").removeClass("col-lg-4"),$("#product_result .product-card").addClass("landscape").removeClass("portrait"))}));var checkAll=["check-a","check-b","check-c","check-d","check-e","check-f"],filterVal={category:"all",rating:0,radio:"all",check:checkAll,range:{from:0,to:100},tags:["tag-one","tag-two","tag-three","tag-four"]},sortVal={sortBy:"price",sortfrom:-1,sortTo:1};function intersection(e,t){return e.filter((function(e){return t.includes(e)}))}function checkFilter(e,t){return"all"===t||e===t}function filterResult(){return $("#product_result").data("items").filter((function(e){return checkFilter(e.category,filterVal.category)&&checkFilter(e.radio,filterVal.radio)&&e.price>=filterVal.range.from&&e.price<=filterVal.range.to&&e.rating>=filterVal.rating&&filterVal.check.indexOf(e.check)>-1&&intersection(filterVal.tags,e.tag).length>0})).sort((function(e,t){return e[sortVal.sortBy]>t[sortVal.sortBy]?sortVal.sortFrom:sortVal.sortTo}))}function productCard(e=0,t=0,a,i,o,n="full",s="portrait",l="#"){var r=`<div class="col col-sm-4">\n    <div class="card product-card portrait ${n}">\n      <a class="waves-effect hidden-link" href=${l}>&nbsp;</a>\n      <div class="figure">\n        <div class="responsive-img" style="background-image:url(${a})">&nbsp;</div>\n      </div>\n      <div class="desc">\n        <div class="text">\n          <h6 class="title pb-2 text-truncate">${i}</h6>\n          <p class="use-text-paragraph">${o}</p>\n        </div>\n        <div>\n          <div class="property">\n            <div class="rating">\n              ${function(e){return'<i class="material-icons star-icon" title="1">star</i>'.repeat(e)+'<i class="material-icons star-icon-disable" title="1">star</i>'.repeat(5-e)}(e)}\n            </div>\n            <strong>$${t}</strong>\n          </div>\n          <a class="btn btn-outlined primary button block" href=${l}>see detail</a>\n        </div>\n      </div>\n    </div>\n  </div>`;return r}function renderResult(){var e=filterResult();for($("#result_length").text(e.length),$("#product_result").html(""),i=0;i<e.length;i++)$("#product_result").append(productCard(e[i].rating,e[i].price,e[i].img,e[i].title,"Category: "+e[i].category+" ~ Tag: "+e[i].tag+" ~ Check: "+e[i].check+" ~ Radio: "+e[i].radio,"round","portrait","/detail-product"))}$("#sort_by").change((function(e){switch(e.target.value){case"title-asc":sortVal.sortBy="title",sortVal.sortFrom=1,sortVal.sortTo=-1;break;case"title-desc":sortVal.sortBy="title",sortVal.sortFrom=-1,sortVal.sortTo=1;break;case"price-asc":sortVal.sortBy="price",sortVal.sortFrom=-1,sortVal.sortTo=1;break;default:sortVal.sortBy="price",sortVal.sortFrom=1,sortVal.sortTo=-1}renderResult()})),$(".filter_category li a").click((function(){var e=$(this).data("value");$(".filter_category li a").removeClass("active"),$(this).addClass("active"),filterVal.category=e,renderResult()})),$(".filter_rating li a").click((function(){var e=$(this).data("value");$(".filter_rating li a").removeClass("active"),$(this).addClass("active"),filterVal.rating=Number(e),renderResult()})),$('.filter_radio li input[type="radio"]').click((function(){var e=$(this).val();$(".filter_radio li").removeClass("active"),$(this).parents(".collection-item").addClass("active"),filterVal.radio=e,renderResult()})),$('.filter_check li input[type="checkbox"]').click((function(){var e=$(this).val();$(".filter_check li").removeClass("active"),$(this).parents(".collection-item").addClass("active"),$(this).is(":checked")?filterVal.check.push(e):removeArray(filterVal.check,e),renderResult()})),$(".select_all_categories").click((function(){filterVal.check=checkAll,$('.filter_check input[type="checkbox"]').prop("checked",!0),renderResult()})),$('.filter_tags .btn-tag input[type="checkbox"]').click((function(){var e=$(this).val();$(this).is(":checked")?filterVal.tags.push(e):removeArray(filterVal.tags,e),renderResult()})),$(".filter_price button").click((function(){filterVal.range.from=Number($("#price_from").val()),filterVal.range.to=Number($("#price_to").val()),renderResult()})),$((function(){$("#modal_filter.modal").modal({onOpenStart:function(){var e=$("#filter_sidebar > aside");e.detach(),$("#filter_mobile").append(e)},onCloseEnd:function(){var e=$("#filter_mobile > aside");e.detach(),$("#filter_sidebar").append(e)}})}));var toastHTML='<span>Message Sent</span><button onclick="M.Toast.dismissAll()" class="btn-icon waves-effect toast-action"><i class="material-icons">close</i></button>';$.validate({form:"#contact_form",onSuccess:function(e){return M.toast({html:toastHTML}),!1}}),$(document).ready((function(){$.validate({form:"#contact_form",onSuccess:function(e){return M.toast({html:'<span>Message Sent</span><button onclick="M.Toast.dismissAll()" class="btn-icon waves-effect toast-action"><i class="material-icons">close</i></button>'}),!1}}),$.validate({form:"#login_form"}),$.validate({form:"#register_form",modules:"security"})}));var darkMode="false";"undefined"!=typeof Storage&&(darkMode=localStorage.getItem("nirwanaDarkMode")||"false");var $header=$("#header"),$menu=$("#mobile_menu"),$slideMenu=$("#slide-menu"),isOpen=!1,isOpenHamburger=!1;function initMap(){var e={lat:44.933076,lng:15.629058},t=document.getElementById("map"),a=new google.maps.InfoWindow({content:'<div id="content" class="buble"><h6 class="title pb-2 px-3">Head Quarter</h6><div class="row ma-3"><div class="col-sm-6 pa-0"><p><i class="material-icons">phone</i> +98 765 432 10</p></div><div class="col-sm-6 pa-0"><p><i class="material-icons">email</i> hello@luxi.com</p></div><div class="col-sm-12 pa-0"><p><i class="material-icons">location_on</i> Lorem ipsum street Block C - Vestibullum Building</p></div></div></div>'});if(t){var i,o=new google.maps.Map(t,{zoom:10,center:e});(i=new google.maps.Marker({position:e,map:o})).addListener("click",(function(){a.open(o,i)}))}}$(document).ready((function(){function e(){$("#main_menu").fadeOut(),$header.removeClass("open-drawer"),$menu.removeClass("is-active"),$slideMenu.removeClass("menu-open")}"true"===darkMode&&($("#app").removeClass("theme--light"),$("#app").addClass("theme--dark"),$("#theme_switcher").prop("checked",!0)),$("#theme_switcher").change((function(){$(this).is(":checked")?(localStorage.setItem("nirwanaDarkMode","true"),$("#app").removeClass("theme--light"),$("#app").addClass("theme--dark")):(localStorage.setItem("nirwanaDarkMode","false"),$("#app").removeClass("theme--dark"),$("#app").addClass("theme--light"))})),$(".dropdown-trigger").dropdown({closeOnClick:!1,alignment:"left"}),$(".droplist-trigger-hover").dropdown({closeOnClick:!1,alignment:"left",hover:!0,coverTrigger:!1}),$(".droplist-trigger-hover-child").dropdown({closeOnClick:!1,alignment:"right",hover:!0,onOpenStart:function(e){for(var t=$(e).parent().siblings().find(".droplist-trigger-hover-child"),a=0;a<t.length;a++)M.Dropdown.getInstance(t[a]).close()}}),$(".droplist-trigger-click").dropdown({closeOnClick:!1,alignment:"left",coverTrigger:!1}),$(".droplist-trigger-click-child").dropdown({closeOnClick:!1,alignment:"right",onOpenStart:function(e){for(var t=$(e).parent().siblings().find(".droplist-trigger-click-child"),a=0;a<t.length;a++)M.Dropdown.getInstance(t[a]).close()}}),$(".megamenu-trigger-click").dropdown({closeOnClick:!1,alignment:"left",coverTrigger:!0,constrainWidth:!0,container:$("#container_menu"),onOpenStart:function(){},onCloseEnd:function(){}}),$("#mobile_menu").click((function(){if(!(isOpen=!isOpen))return $(".sidenav").sidenav("close"),!1;$(".sidenav").sidenav("open")})),$("#hamburger_menu").click((function(){(isOpenHamburger=!isOpenHamburger)?($("#main_menu").fadeIn(),$header.addClass("open-drawer"),$menu.addClass("is-active"),$slideMenu.addClass("menu-open"),$(this).addClass("is-active")):(e(),$(this).removeClass("is-active"))})),$("#main_menu a").click((function(){e(),isOpenHamburger=!1})),$(".sidenav").sidenav({onOpenStart:function(){isOpen=!0,$header.addClass("open-drawer"),$menu.addClass("is-active"),$slideMenu.addClass("menu-open")},onCloseEnd:function(){isOpen=!1,$header.removeClass("open-drawer"),$menu.removeClass("is-active"),$slideMenu.removeClass("menu-open")}})})),$((function(){$("#lang_menu li").click((function(){var e=$(this).children(),t=window.location.toString(),a=window.location.pathname.split("/"),i=a[a.length-2],o=a[a.length-1],n=e.data("lang");window.location=t.replace(i+"/"+o,n+"/"+o)})),$("#lang_select").on("change",(function(){var e=$(this).val(),t=window.location.toString(),a=window.location.pathname.split("/"),i=a[a.length-2],o=a[a.length-1];return e&&(window.location=t.replace(i+"/"+o,e+"/"+o)),!1}))})),$(document).ready((function(){var e=$("#detail_carousel");e.slick({dots:!0,arrows:!1,slidesToShow:1,infinite:!1,autoplay:!1}),e.each((function(){$(this).magnificPopup({delegate:".image a",type:"image",mainClass:"mfp-with-zoom",gallery:{enabled:!0},zoom:{enabled:!0,duration:300,easing:"ease-in-out",opener:function(e){return e.is("img")?e:e.find("img")}}})}))}));var mq={smUp:"screen and (min-wdth: 600px)",mdUp:"screen and (min-width: 960px)",lgUp:"screen and (min-width: 1280px)",xlUp:"screen and (min-width: 1920px)",xsDown:"screen and (max-width: 599px)",smDown:"screen and (max-width: 959px)",mdDown:"screen and (max-width: 1279px)",lgDown:"screen and (max-width: 1919px)"};function mqAddClass(e){$(e).each((function(){var e=$(this).data("class");$(this).addClass(e)}))}function mqRemoveClass(e){$(e).each((function(){var e=$(this).data("class");$(this).removeClass(e)}))}var handler_smUp={match:function(){mqAddClass(".mq-sm-up")},unmatch:function(){mqRemoveClass(".mq-sm-up")}},handler_mdUp={match:function(){mqAddClass(".mq-md-up")},unmatch:function(){mqRemoveClass(".mq-md-up")}},handler_lgUp={match:function(){mqAddClass(".mq-lg-up")},unmatch:function(){mqRemoveClass(".mq-lg-up")}},handler_xlUp={match:function(){mqAddClass(".mq-xl-up")},unmatch:function(){mqRemoveClass(".mq-xl-up")}},handler_xsDown={match:function(){mqAddClass(".mq-xs-down")},unmatch:function(){mqRemoveClass(".mq-xs-down")}},handler_smDown={match:function(){mqAddClass(".mq-sm-down")},unmatch:function(){mqRemoveClass(".mq-sm-down")}},handler_mdDown={match:function(){mqAddClass(".mq-md-down")},unmatch:function(){mqRemoveClass(".mq-md-down")}},handler_lgDown={match:function(){mqAddClass(".mq-lg-down")},unmatch:function(){mqRemoveClass(".mq-lg-down")}};enquire.register(mq.smUp,handler_smUp).register(mq.mdUp,handler_mdUp).register(mq.lgUp,handler_lgUp).register(mq.xlUp,handler_xlUp).register(mq.xsDown,handler_xsDown).register(mq.smDown,handler_smDown).register(mq.mdDown,handler_mdDown).register(mq.lgDown,handler_lgDown),$((function(){$("#speciality_carousel").slick({dots:!1,infinite:!0,speed:500,centerMode:!0,arrows:!1,autoplay:!0,autoplaySpeed:3e3,slidesToShow:1,slidesToScroll:1,vertical:!0})})),$((function(){var e=$("#testimonial_carousel");if(window.innerWidth>1279&&"ltr"===$("html").attr("dir")){var t=Math.floor(e.data("length")-4+1);setTimeout((function(){e.slick("slickGoTo",t)}),100)}e.slick({dots:!0,infinite:!1,speed:500,slidesToShow:4,arrows:!1,slidesToScroll:1,variableWidth:!0,responsive:[{breakpoint:1100,settings:{slidesToShow:2,slidesToScroll:1,infinite:!0,dots:!0}},{breakpoint:800,settings:{slidesToShow:2}},{breakpoint:600,settings:{slidesToShow:1}}]});var a=$("#art_testimonials");e.on("afterChange",(function(t,i){var o=Math.floor(e.data("length")-4);i.currentSlide<=o?a.addClass("faded"):a.removeClass("faded")}))}));var $header=$("header.header.app-bar"),$pageNav=$("#page_nav"),sticky=0;function fixedNav(){window.pageYOffset>sticky?$header.addClass("fixed"):$header.removeClass("fixed")}function fixedFabNav(){window.pageYOffset>500?$pageNav.addClass("show"):$pageNav.removeClass("show")}$("#header").length>0&&(sticky=$header[0].offsetTop+80);var progressOffset=0,$progress=$("#progress").offset();function playProgress(){window.pageYOffset>progressOffset&&$("#progress").removeClass("zero")}$("#progress").length>0&&(progressOffset=$progress.top-200),$(document).ready((function(){setTimeout((function(){window.onscroll=function(){playProgress(),fixedNav(),fixedFabNav()}}),500),$("#preloader").delay(1e3).fadeOut("fast"),$(".transition-page").addClass("page-fadeUp-transition-enter").delay(1e3).queue((function(){$(this).removeClass("page-fadeUp-transition-enter").addClass("page-fadeUp-transition-enter-active").dequeue().delay(1400).queue((function(){$(this).removeClass("page-fadeUp-transition-enter-active").addClass("page-fadeUp-transition-exit").dequeue()}))})),$(".scrollnav").navScroll({scrollSpy:!0,activeParent:!0,activeClassName:"current"}),(new WOW).init(),$(".collapsible").collapsible();var e=document.querySelector(".collapsible.expandable");M.Collapsible.init(e,{accordion:!1});$(".select").formSelect(),$(".tooltipped").tooltip()}));
var isOpenSide=!1;$((function(){$("#slidemenu").sidenav({edge:"right",draggable:!1,onOpenStart:function(){isOpenSide=!0,$(".btn-float-opt").addClass("active")},onCloseStart:function(){isOpenSide=!1,$(".btn-float-opt").removeClass("active")}}),$(".opt-wrap .tabs").tabs({swipeable:!1}),$("#open_palette").click((function(){(isOpenSide=!isOpenSide)?$("#slidemenu").sidenav("open"):$("#slidemenu").sidenav("close"),$(".tabs").tabs("select","palette_options")})),$("#open_layouts").click((function(){(isOpenSide=!isOpenSide)?$("#slidemenu").sidenav("open"):$("#slidemenu").sidenav("close"),$(".tabs").tabs("select","layouts_options")})),$("#open_explore").click((function(){(isOpenSide=!isOpenSide)?$("#slidemenu").sidenav("open"):$("#slidemenu").sidenav("close"),$(".tabs").tabs("select","explore_theme")})),$("#close_sideright").click((function(){$("#slidemenu").sidenav("close")})),$("#theme_switcher_side").change((function(){$(this).is(":checked")?(localStorage.setItem("nirwanaDarkMode","true"),$("#app").removeClass("theme--light"),$("#app").addClass("theme--dark")):(localStorage.setItem("nirwanaDarkMode","false"),$("#app").removeClass("theme--dark"),$("#app").addClass("theme--light"))})),$("#dir_switcher_side").change((function(){$(this).is(":checked")?$("html").attr("dir","rtl"):$("html").attr("dir","ltr")}));var e=document.getElementsByClassName("img-2d3d");$("#image_switcher_side").change((function(){if($(this).is(":checked"))for(var t=0;t<e.length;t++)e[t].setAttribute("src",e[t].getAttribute("data-3d"));else for(t=0;t<e.length;t++)e[t].setAttribute("src",e[t].getAttribute("data-2d"))})),$(".theme-color .swatch").click((function(){var e=$(this).data("color"),t=$("*[class*='-var']");$(".theme-color .swatch").removeClass("active"),$(this).addClass("active"),t.attr("class",(function(e,t){return $.grep(t.split(/ +/),(function(e){return!e.match(/-var/)})).join(" ")})),$("#main-wrap").addClass(e+"-var")})),$("#custom_header .ly-btn").click((function(){var e=$(this).data("header");$(".header-component").removeClass("active"),$(".header-"+e).addClass("active"),$("#custom_header .ly-btn").removeClass("active"),$(this).addClass("active"),"hamburger"===e||"basic"===e||"search"===e?$("#mobile_menu").hide():$("#mobile_menu").show(),"basic"===e?$("nav.user-menu .btn-flat").hide():$("nav.user-menu .btn-flat").show()})),$("#custom_footer .ly-btn").click((function(){var e=$(this).data("footer");$(".footer-component").removeClass("active"),$("#footer-"+e).addClass("active"),$("#custom_footer .ly-btn").removeClass("active"),$(this).addClass("active")})),$("#custom_corner .ly-btn").click((function(){var e=$(this).data("corner");$(".corner-component").removeClass("active"),$("#corner-"+e).addClass("active"),$("#custom_corner .ly-btn").removeClass("active"),$(this).addClass("active")}))}));